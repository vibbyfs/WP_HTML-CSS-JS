...
ScrollReveal().reveal(".bestseller__header", {
  ...scrollRevealOption,
  origin: "right",
});
...
const sortCards = (order) => {
  ...
  const container = document.querySelector(".menu__filter__card");
...
document.querySelector(".menu__dropdown__btn").addEventListener("click", () => {
